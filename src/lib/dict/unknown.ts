...
const pl = {
  ...
  cta: "Ułóż podróż",
  working: "Pytam model, potem sprawdzam każdą płytę w MusicBrainz",
  workingShort: "Szukam…",
...
const en: T = {
  ...
  working: "Asking the model, then checking every album against MusicBrainz",
...
const es: T = {
  ...
  cta: "Armar el viaje",
  working: "Pregunto al modelo y luego compruebo cada disco en MusicBrainz",
...
const de: T = {
  ...
  working: "Ich frage das Modell und prüfe dann jedes Album über MusicBrainz",
  workingShort: "Suche…",
  youAsked: "Ich suche",
  cancel: "Abbrechen",
