...
const pl = {
  ...
  workingShort: "Szukam…",
  youAsked: "Szukam dla Ciebie",
  cancel: "Przerwij",
  leaveOk: "Możesz stąd wyjść — podróż układa się dalej i poczeka pod tym adresem.",
  gone: "Nie mam już tej podróży. Notatki o układaniu trzymamy dobę.",
  ...
  honestNote: "Każdą płytę portal potwierdza w MusicBrainz — czego nie potwierdzi, nie zobaczysz. Dzięki temu w każdą pozycję da się wejść i zobaczyć skład.",
  ...
  errors: {
    ...
    limit: "Na dziś koniec — możesz ułożyć {n} podróży dziennie. Każde szukanie kosztuje. Wróć jutro.",
    ...
    urwane: "Układanie podróży urwało się w pół drogi. Spróbuj jeszcze raz — zwykle za drugim razem idzie.",
...
const en: T = {
  ...
  youAsked: "Looking for",
  cancel: "Cancel",
  leaveOk: "You can leave this page — the journey keeps building and will wait at this address.",
  gone: "That journey is gone. Notes about building one are kept for a day.",
  ...
  honestNote: "The portal confirms every album against MusicBrainz — anything it can't confirm, you won't see. That's why every entry opens into a real line-up.",
  ...
  errors: {
    ...
    limit: "That's it for today — {n} journeys a day. Every search costs money. Come back tomorrow.",
    ...
    urwane: "Building the journey broke off halfway. Try again — the second run usually goes through.",
...
const es: T = {
  ...
  youAsked: "Buscando",
  cancel: "Cancelar",
  leaveOk: "Puedes salir de aquí: el viaje se sigue armando y te esperará en esta dirección.",
  gone: "Ese viaje ya no está. Las notas sobre el armado se guardan un día.",
  ...
  honestNote: "El portal confirma cada disco en MusicBrainz: lo que no se confirme, no lo verás. Por eso cada entrada abre una formación real.",
  ...
  errors: {
    ...
    limit: "Por hoy basta: {n} viajes al día. Cada búsqueda cuesta. Vuelve mañana.",
    ...
    urwane: "La creación del viaje se cortó a medias. Inténtalo otra vez; la segunda suele funcionar.",
...
const de: T = {
  ...
  youAsked: "Ich suche",
  cancel: "Abbrechen",
  leaveOk: "Du kannst die Seite verlassen — die Reise wird weiter gebaut und wartet unter dieser Adresse.",
  gone: "Diese Reise gibt es nicht mehr. Notizen zum Bauen halten wir einen Tag.",
  ...
  honestNote: "Das Portal bestätigt jedes Album über MusicBrainz — was sich nicht bestätigen lässt, siehst du nicht. Deshalb führt jeder Eintrag zu einer echten Besetzung.",
  ...
  errors: {
    ...
    limit: "Für heute Schluss — {n} Reisen pro Tag. Jede Suche kostet. Komm morgen wieder.",
    ...
    urwane: "Das Zusammenstellen ist auf halbem Weg abgebrochen. Versuch es noch einmal — beim zweiten Mal klappt es meist.",
