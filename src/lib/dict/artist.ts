...
const pl = {
  ...
  timeline: {
    ...
    markStudio: "album studyjny",
    markLive: "koncertówka",
    markEp: "EP",
    markCompilation: "składanka",
    markThisOne: "ta płyta",
    markOther: "inne wydawnictwo",
    markLegendNote: "Pionowe kreski to wydawnictwa zespołu, ustawione na osi lat. Kliknij rodzaj, żeby go schować.",
    lineupNone: "MusicBrainz nie ma tu składu — nie ma z czego zrobić osi czasu.",
    careerNone: "MusicBrainz nie wie, w jakich zespołach grała ta osoba — nie ma z czego zrobić osi czasu.",
...
const en: T = {
  ...
  timeline: {
    ...
    markStudio: "studio album",
    markLive: "live album",
    markEp: "EP",
    markCompilation: "compilation",
    markThisOne: "this album",
    markOther: "other release",
    markLegendNote: "Vertical lines are the band's releases, placed on the year axis. Click a type to hide it.",
    lineupNone: "MusicBrainz has no lineup here — nothing to draw a timeline from.",
    careerNone: "MusicBrainz does not know which bands this person played in — nothing to draw a timeline from.",
...
const es: T = {
  ...
  timeline: {
    ...
    markStudio: "álbum de estudio",
    markLive: "álbum en directo",
    markEp: "EP",
    markCompilation: "recopilatorio",
    markThisOne: "este disco",
    markOther: "otro lanzamiento",
    markLegendNote: "Las líneas verticales son los lanzamientos del grupo, situados en el eje de los años. Pulsa un tipo para ocultarlo.",
    lineupNone: "MusicBrainz no tiene la formación aquí — no hay con qué dibujar la línea temporal.",
    careerNone: "MusicBrainz no sabe en qué bandas tocó esta persona — no hay con qué dibujar la línea temporal.",
...
const de: T = {
  ...
  timeline: {
    ...
    markStudio: "Studioalbum",
    markLive: "Livealbum",
    markEp: "EP",
    markCompilation: "Kompilation",
    markThisOne: "diese Platte",
    markOther: "andere Veröffentlichung",
    markLegendNote: "Die senkrechten Striche sind Veröffentlichungen der Band auf der Jahresachse. Klicke einen Typ an, um ihn auszublenden.",
    lineupNone: "MusicBrainz hat hier keine Besetzung — daraus lässt sich keine Zeitleiste zeichnen.",
    careerNone: "MusicBrainz weiß nicht, in welchen Bands diese Person gespielt hat — daraus lässt sich keine Zeitleiste zeichnen.",
