...
const pl = {
  ...
  search: "Szukaj",
  back: "Wstecz",
  share: "Skopiuj adres tej strony",
  shareCopied: "Adres skopiowany",
  shareFailed: "Nie udało się skopiować",
...
const es: T = {
  ...
  bestOf: "Lo mejor",
  lists: "Viajes",
  chat: "Hacia lo desconocido",
  logIn: "Iniciar sesión",
  logOut: "cerrar sesión",
  me: "Perfil",
  search: "Buscar",
  back: "Atrás",
  share: "Copiar el enlace de esta página",
...
const de: T = {
  ...
  search: "Suchen",
  back: "Zurück",
  share: "Link dieser Seite kopieren",
  shareCopied: "Link kopiert",
  shareFailed: "Kopieren nicht möglich",
